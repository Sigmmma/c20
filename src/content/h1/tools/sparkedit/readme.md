...
---
**SparkEdit** was a direct [map](~) editor for H1PC. It features a scenario editor/viewer where users can place and modify objects. In this way it is similar to [Sapien](~).
