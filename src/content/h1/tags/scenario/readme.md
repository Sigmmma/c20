...
A scenarios can be compiled with its dependencies into a [map](~maps). Though [Tool](~h1a-tool) will also will include [globals](~), tag collections, and some UI tags automatically, the majority of a map's tags are direct or indirect dependencies of the scenario.
