...
| danger radius | real | AI will try to avoid this projectile from this far away in WU, when set to a non-zero value for attaching projectiles, will trigger AI to use their "enemy stuck by grenade" dialoug
