...
| `+weatherpoly` | Used on the faces of simply [convex shapes](https://en.wikipedia.org/wiki/Polyhedron#Convex_polyhedra) to generate [weather polyhedra](~h3/tags/scenario_structure_bsp#weather-polyhedra). This has been deprecated and replaced by [clusters](~h3/tags/scenario_structure_bsp#clusters-and-cluster-data).
