...
---
**Jointed Model Skeleton** (JMS) is text-based geometry file format used when importing levels and other models into early generation Halo tag formats. The file contains information such as vertices, normals, material names, UV coordinates, and rigging.

JMS serves as an intermediate step between your 3D editor and Halo's tags system. You can export JMS directly from [Blender](~) or [3ds Max](~3dsmax) using their respective community-made addons, or by first exporting to [FBX](~fbx) and using Tool to [convert to JMS](~h1-tool#fbx-to-jms).
