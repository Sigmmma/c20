...
The **Osoyoos launcher** supports creating and switching through a variety of profiles. You can create and configure profiles from the **Osoyoos - Profiles** menu which you can open with the **Toolkit Profiles** button shown below:

![](profile_menu.jpg "Make 10, 20, 30, or 40 profiles to surprise your friends and colleagues! They'll still be typing into command prompt by the time you've launched a lightmap farm in Halo 3 and compiled several sounds in Halo 1.")
...
![](profile_settings.jpg "Set it and forget it.")
